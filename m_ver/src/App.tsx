...
function App() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-neutral-50">
      {/* 입력창까지 상단에 고정해 스크롤 중에도 언제든 바로 할일을 추가할 수 있게 한다(모바일 앱과 유사한 패턴). */}
      <header
        className="sticky top-0 z-10 border-b border-neutral-200 bg-neutral-50/95 backdrop-blur-sm"
      ...
      <div
        className="mx-auto flex w-full max-w-2xl flex-1 flex-col gap-5 px-4 pt-4 sm:px-6 sm:pt-6"
